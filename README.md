# Идеи рефакторинга external_requests
1. Я бы убрал апи токен в отдельный конфиг файл
2. Сделал бы функцию get_weather_url глобальной что бы не дублировать код в двух классах

# Возможные проблемы при масштабировании
При масштабировании кол-во запросов к api будет больше и нужно учитывать лимиты самого api OpenWeatherMap
